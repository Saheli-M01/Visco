    ...
    <div className="mx-auto px-3 py-2">
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-3">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
              <div className="flex-1 min-w-0">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1 break-words">{algorithm.name}</h3>
        ...
        <div className="lg:col-span-3 space-y-3">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="backdrop-blur-sm bg-white/90 border border-white/30 rounded-2xl p-3 sm:p-4 shadow-xl">
