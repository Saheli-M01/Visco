...
const TypeInteractions = () => {
  ...
  return (
    <section id="type-interactions" className="scroll-mt-20 space-y-6">
      <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 border-b pb-2">
        5A. Type Interactions & Operations
      </h1>
      ...
      <div className="space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">1. Integer + Integer (int + int)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">2. Integer + Float (int + float)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">3. String + String (str + str)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">4. String + Integer (str + int) - ERROR</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">5. String * Integer (str * int)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">6. Boolean + Integer (bool + int)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">7. Boolean + Boolean (bool + bool)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">8. Boolean + String (bool + str) - ERROR</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">9. Float + Float (float + float)</h2>
        ...
        <div className="pt-2">
          <h2 className="text-lg font-semibold text-slate-800 dark:text-slate-200">10. Boolean + Float (bool + float)</h2>
      ...
      <div className="space-y-4 pt-4 border-t">
        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">
          11. Type Casting (Type Conversion)
        </h2>
        <p className="text-slate-600 dark:text-slate-350 leading-relaxed">
        ...
        <div className="space-y-3">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">A. Implicit Type Conversion (Automatic)</h3>
          <p className="text-slate-600 dark:text-slate-350 leading-relaxed">
        ...
        <div className="space-y-3 pt-2">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">B. Explicit Type Conversion (Manual)</h3>
          <p className="text-slate-600 dark:text-slate-350 leading-relaxed">
        ...
        <div className="space-y-2 pt-2">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Comparison: Implicit vs Explicit Type Conversion</h3>
          <NoteTable headers={comparisonHeaders} rows={comparisonRows} />
        </div>

        <div className="space-y-2 pt-2">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200">Important Rules for Type Conversion:</h3>
      ...
      <div className="space-y-3 pt-4 border-t">
        <h2 className="text-xl font-bold text-slate-850 text-emerald-600 dark:text-emerald-400">
          Complete Type Interactions Table
        </h2>
