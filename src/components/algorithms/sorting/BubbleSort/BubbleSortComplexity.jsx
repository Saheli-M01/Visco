...
// Generate data for Bubble Sort breakdown
const generateBreakdownData = () => {
  const data = [];
  for (let n = 1; n <= 50; n += 2) {
    data.push({
      n,
      best: calculateComplexity(n, "n"),
      average: calculateComplexity(n, "n²"),
      worst: calculateComplexity(n, "n²"),
    });
  }
  return data;
};
    ...
    >
      ...
      >
        <h3 className="text-lg font-bold text-white mb-2">
          Bubble Sort - Complexity Breakdown
        </h3>
        <div className="text-sm text-gray-300 mb-4">
          Best, Average, and Worst case scenarios for Bubble Sort
        </div>
