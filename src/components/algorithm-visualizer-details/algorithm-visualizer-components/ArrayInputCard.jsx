    ...
    <div className="bg-white  rounded-xl p-2">
      ...
      <div className="space-y-3">
        <div className="relative flex gap-1">
          ...
          />
            <button onClick={onGo} className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-all shadow-md text-sm font-medium border border-gray-600">Go</button>
          {showValidationPopup && (
