...
import BinarySearchComplexity from "../../algorithms/array/BinarySearch/BinarySearchComplexity";
import NextPermutationComplexity from "../../algorithms/array/NextPermutation/NextPermutationComplexity";
import DutchFlagComplexity from "../../algorithms/array/Dutch/DutchFlagComplexity";
import KadanesComplexity from "../../algorithms/array/Kadanes/KadanesComplexity";
import SlidingWindowComplexity from "../../algorithms/array/SlidingWindow/SlidingWindowComplexity";
import MooresVotingComplexity from "../../algorithms/array/MooresVoting/MooresVotingComplexity";
...
const codeLoaders = {
  ...
  "Dutch Flag": () => import("../../algorithms/array/Dutch/dutchFlagcodes"),
  "Next Permutation": () =>
...
// Complexity components placeholder (to mirror SortingDetails structure)
// Map algorithm names to their complexity components when available
const complexityComponents = {
  "Binary Search": BinarySearchComplexity,
  "Next Permutation": NextPermutationComplexity,
  "Dutch Flag": DutchFlagComplexity,
  "Kadane's Algorithm": KadanesComplexity,
  "Sliding Window / 2 pointers (Container With Most Water)": SlidingWindowComplexity,
  "Moore's Voting Algorithm": MooresVotingComplexity,
                        ...
                        <div className="flex gap-1">
                          {step.array.map((num, idx) => {
                            ...
                            return (
                              <motion.div
                                key={idx}
                                animate={isSwapped ? { scale: [1, 1.15, 1] } : {}}
