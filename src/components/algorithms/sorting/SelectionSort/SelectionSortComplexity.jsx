...
// Compute the common complexity curves we want to plot
...
// Selection Sort is O(n^2) in all cases; we still emit all three series for UI consistency
const generateBreakdownData = () => {
	const data = [];
	for (let n = 1; n <= 50; n += 2) {
		data.push({
			n,
			best: calculateComplexity(n, "n^2"),
			average: calculateComplexity(n, "n^2"),
		...
		>
			...
			>
				<h3 className="text-lg font-bold text-white mb-2">
					Selection Sort - Complexity Breakdown
				</h3>
				<div className="text-sm text-gray-300 mb-4">
					Best, Average, and Worst case scenarios for Selection Sort
				</div>
