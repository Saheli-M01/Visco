...
const docs = [
  {
    ...
    description:
      "Complete beginner to advanced Python notes covering data types, control flow, functions, and more.",
  ...
  },
  {
    title: "JavaScript",
    description:
      "JavaScript reference and interview notes — fundamentals, DOM, async patterns, and ES6+ features.",
    from: "from-amber-400",
    to: "to-orange-500",
    solid: "#f59e0b",
            ...
            {docs.map((doc) => {
              ...
              return (
                <div
                  ...
                  className={`group relative rounded-[26px] p-[1.5px] bg-gradient-to-br ${doc.ring} cursor-pointer transition-all duration-500 hover:-translate-y-1.5 ${
                    isComingSoon ? "opacity-80" : `hover:${doc.glow}`
